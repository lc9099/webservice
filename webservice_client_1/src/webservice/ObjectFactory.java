...
public class ObjectFactory {
    ...
    private final static QName _Other_QNAME = new QName("http://webservice/", "other");
    ...
    private final static QName _OtherResponse_QNAME = new QName("http://webservice/", "otherResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "other")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "otherResponse")
